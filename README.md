...
- 채팅 페이지
  - 약속 수정이 되지 않는다.
- 결제 페이지
  - 결제할때 개인 이메일이 아닌 사이트 이메일로 나와요. 결제하면 결제내역은 볼 수 없어요
...
로그인을 폰번호 인증으로 대체한게 아이디어가 좋은 것 같습니다!
사진을 업로드 하지 않았을 경우를 대비해 default image를 사용한게 아이디어가 좋은 것 같습니다!
